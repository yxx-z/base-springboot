...
/**
 * @author yxx
 * @classname WSServerInitial
 * @since 2023/09/16
 */
public class WSServerInitial extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) {
         ...
         */
        pipeline.addLast(new WebSocketServerProtocolHandler(socketProperties().getPath()));
